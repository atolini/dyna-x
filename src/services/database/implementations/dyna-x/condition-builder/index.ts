...
/**
 * Result structure returned by the ConditionBuilder after building the condition expression.
 *
 * @template V The type of the values in ExpressionAttributeValues. Defaults to any.
 */
export type ConditionExpressionResult = {
  /**
  ...
  /**
   * A mapping between placeholder names and actual attribute names.
   * Used to safely reference attributes in DynamoDB queries.
   */

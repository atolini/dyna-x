 ...
 */
export class CognitoUserService<T extends AttributeType> implements IUserService<T> {
     ...
     */
    async updateUserAttributes(input: UpdateUserAttributesInput<T>): Promise<void> {

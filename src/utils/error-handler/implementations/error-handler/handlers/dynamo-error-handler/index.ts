  ...
  handle(error: Error, logger: ILogger<any>, resBuilder: R): T {
    ...
    if (error instanceof ProvisionedThroughputExceededException) {
      logger.error({
        ...
        details:
          'The request rate is too high for the provisioned capacity. Consider increasing RCPU/WCPU or using adaptive capacity.',
      });
    ...
    // Handling ConditionalCheckFailedException error
      ...
      logger.warn({
        ...
        message: error.message,
        details:
          'The conditional update/delete operation failed because conditions were not met.',
      });
    ...
    // Handling ItemCollectionSizeLimitExceededException error
      ...
      logger.error({
        ...
        message: error.message,
        details:
          'The item collection (table + LSI/GSI) exceeded the 10GB limit per partition key.',
      });
    ...
    // Handling LimitExceededException error
      ...
      logger.error({
        ...
        message: error.message,
        details:
          'Exceeded AWS account/table limits (e.g., maximum tables, indexes).',
      });
